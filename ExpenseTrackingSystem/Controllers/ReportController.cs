...
namespace ExpenseTrackingSystem.Controllers
{
    ...
    public class ReportsController : ControllerBase
    {
        ...
        public async Task<IActionResult> SendSummaryEmail([FromBody] EmailReportRequestDto request)
        {
            var username = User.Identity?.Name ?? "UnknownUser";
            await _reportService.SendSummaryReportToEmailAsync(username, request.Email, request.LastNDays);
