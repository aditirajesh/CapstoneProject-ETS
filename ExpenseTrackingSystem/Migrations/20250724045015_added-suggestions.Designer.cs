...
namespace ExpenseTrackingSystem.Migrations
{
    ...
    [Migration("20250724045015_added-suggestions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpenseTrackingSystem.Models.Suggestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("AnalyserUsername")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ExpenseTrackingSystem.Models.Suggestion", b =>
                {
                    b.HasOne("ExpenseTrackingSystem.Models.User", null)
                        .WithMany()
                        .HasForeignKey("AnalyserUsername")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
